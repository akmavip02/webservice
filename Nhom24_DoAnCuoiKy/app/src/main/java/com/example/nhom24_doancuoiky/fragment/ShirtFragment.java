...
import com.example.nhom24_doancuoiky.adapter.ProductAdapter;
...
public class ShirtFragment extends Fragment {
    ...
    ArrayList<ProductApiResponse> listShirtProduct;
    ...
    private void setEvent() {
        loadData();
        ProductAdapter productAdapter = new ProductAdapter(getContext(), R.layout.item_product_layout, listShirtProduct);
...
//        listProduct.add(new Product(6,6,4,1,30,"gang tay","boxing","https://vothuattayson.vn/wp-content/uploads/gang-tay-boxing-title.jpg"));
    ...
    private void loadData() {
        addData();
        listShirtProduct = new ArrayList<>();
//        for (Product str : listProduct) {
//            if(str.getCategory_id() == 1){
//                listShirtProduct.add(str);
//            }
//        }
    }
