...
import com.example.nhom24_doancuoiky.converter.UserConverter;
import com.example.nhom24_doancuoiky.response.UserApiResponse;
                    ...
                    JsonObjectRequest jsonObjectRequest1 = new JsonObjectRequest(Request.Method.GET, url, null,
                            new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    ...
                                    final String username = "n18dccn050@student.ptithcm.edu.vn";
                                    final String password = "hflbmxpyitbxqhpu";
                                    ...
                                    params.put("name", userApiResponse.getName().toString());
                                    params.put("email", userApiResponse.getEmail().toString());
                                    params.put("phone", userApiResponse.getPhone().toString());
                                    params.put("roleCode", "CUSTOMER");
