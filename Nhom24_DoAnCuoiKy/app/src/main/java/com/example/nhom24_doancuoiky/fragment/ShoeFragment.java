...
public class ShoeFragment extends Fragment {
    ...
    ArrayList<ProductApiResponse> listShoeProduct;
    ...
    private void setEvent() {
        loadData();
        ProductAdapter productAdapter = new ProductAdapter(getContext(), R.layout.item_product_layout, listShoeProduct);
...
//        listProduct.add(new Product(6,6,4,1,30,"gang tay","boxing","https://vothuattayson.vn/wp-content/uploads/gang-tay-boxing-title.jpg"));
    ...
    private void loadData() {
        addData();
        listShoeProduct = new ArrayList<>();
//        for (Product str : listProduct) {
//            if(str.getCategory_id() == 3){
//                listShoeProduct.add(str);
//            }
//        }
    }
