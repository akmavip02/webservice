...
import com.example.nhom24_doancuoiky.model.ProductSize;
...
public class ProductAdapter extends ArrayAdapter<ProductApiResponse> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Picasso.get().load(ApiConstant.URL_IMG + productApiResponse.getImages().get(0)).into(ivImage);
        setEvent(position);
        return convertView;
    }
                        ...
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                StringBuilder url = new StringBuilder(ApiConstant.URL_API)
                                        ...
                                        .append("&sizeCode=NEW") // auto nguoi lon
